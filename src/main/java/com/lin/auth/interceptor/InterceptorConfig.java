...
import com.lin.auth.utils.HttpHelper;
...
//        MyRequestWrapper request = new MyRequestWrapper(requests);
//        // 获取参数
...
//        String body = new String(bodyBytes, request.getCharacterEncoding());
        String body = HttpHelper.getBodyString(requests);
        ...
        logger.info(String.valueOf(flagB));
        return flagB;
    }
}
